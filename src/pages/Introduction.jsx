...
// <div>
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white px-6 md:px-16 py-20">
      ...
      >
        ...
        className="w-full bg-transparent border-b-2 border-black text-center text-4xl font-semibold p-2 focus:outline-none max-w-xs z-50 "
      >
        <input
          type="text"
       ...
       <motion.div
        className="absolute w-[400px] h-[400px] border border-dotted border-gray-800 rotate-45"
        initial={{  scale: 0.8 }}
        animate={{  scale: 1, rotate: 360 }}
        transition={{ duration: 29, repeat: Infinity, ease:'linear' }}
      ></motion.div>
      <motion.div
        className="absolute w-[500px] h-[500px] border border-dotted border-gray-600 rotate-45"
        initial={{ scale: 0.8 }}
        animate={{ scale: 1, rotate: -360 }}
        transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
      ></motion.div>
      <motion.div
        className="absolute w-[600px] h-[600px] border border-dotted border-gray-500 rotate-45"
        initial={{  scale: 0.8 }}
        animate={{  scale: 1, rotate: 360 }}
